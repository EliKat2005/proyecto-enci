...
from .models import (
    PlanDeCuentas,
    Empresa, EmpresaPlanCuenta, EmpresaAsiento, EmpresaTransaccion, EmpresaTercero,
    EmpresaSupervisor, EmpresaComment, PeriodoContable
)
...
class EmpresaPlanCuentaAdmin(admin.ModelAdmin):
    list_display = ('empresa', 'codigo', 'descripcion', 'tipo', 'naturaleza', 'es_auxiliar', 'activa')
...
class EmpresaTerceroAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'numero_identificacion', 'tipo', 'empresa', 'activo', 'fecha_creacion')
