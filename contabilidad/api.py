...
from contabilidad.models import Empresa, EmpresaPlanCuenta, EmpresaAsiento, EmpresaTransaccion
...
class TransaccionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'cuenta', 'cuenta_codigo', 'cuenta_descripcion', 'detalle_linea', 'debe', 'haber']
...
class EmpresaViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def libro_mayor(self, request, pk=None):
        ...
        if not cuenta_id:
            return Response({'detail': 'cuenta_id es requerido'}, status=status.HTTP_400_BAD_REQUEST)
        ...
        saldo_acum = LibroMayorService.calcular_saldos_cuenta(cuenta, fecha_inicio, fecha_fin)['saldo_inicial']
