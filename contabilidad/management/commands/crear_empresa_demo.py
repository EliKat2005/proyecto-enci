...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--user", type=str, help="Username del propietario de la empresa demo", default="admin"
        )
        parser.add_argument(
            "--delete", action="store_true", help="Eliminar empresa demo existente antes de crear"
        )
    ...
    def handle(self, *args, **options):
        ...
        if Empresa.objects.filter(nombre="Comercial Demo S.A.").exists():
            raise CommandError(
                'La empresa "Comercial Demo S.A." ya existe. Use --delete para eliminarla primero.'
            )
    ...
    def _crear_plan_cuentas(self, empresa):
        ...
        cuentas_map["caja"] = EmpresaPlanCuenta.objects.create(
            ...
            es_auxiliar=True,
            estado_situacion=True,
            padre=cuentas_map["activo_corriente"],
            activa=True,
        )
        ...
        cuentas_map["banco"] = EmpresaPlanCuenta.objects.create(
            empresa=empresa,
            codigo="1.1.02",
            descripcion="Banco Nacional - Cta. Corriente",
            tipo=TipoCuenta.ACTIVO,
            naturaleza=NaturalezaCuenta.DEUDORA,
            es_auxiliar=True,
            estado_situacion=True,
        ...
        cuentas_map["inventario"] = EmpresaPlanCuenta.objects.create(
            empresa=empresa,
            codigo="1.1.04",
            descripcion="Inventario de Mercaderías",
            tipo=TipoCuenta.ACTIVO,
            naturaleza=NaturalezaCuenta.DEUDORA,
            es_auxiliar=True,
            estado_situacion=True,
        ...
        cuentas_map["proveedores"] = EmpresaPlanCuenta.objects.create(
            ...
            es_auxiliar=True,
            estado_situacion=True,
            padre=cuentas_map["pasivo_corriente"],
            activa=True,
        )
        ...
        cuentas_map["sueldos"] = EmpresaPlanCuenta.objects.create(
            ...
            es_auxiliar=True,
            estado_situacion=False,
            padre=cuentas_map["gastos_admin"],
            activa=True,
        )
    ...
    def _crear_periodos(self, empresa):
        ...
        for mes in range(1, 13):
            periodo = PeriodoContable.objects.create(
                empresa=empresa, anio=2025, mes=mes, estado=PeriodoContable.EstadoPeriodo.ABIERTO
            )
